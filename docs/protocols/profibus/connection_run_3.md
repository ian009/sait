...
Using the [Fieldcare](../../fieldcare/fieldcare.md) package on the workstation to communicate with [Profibus](../../indexes/index_devices_profibus.md) devices installed on [Run 3](../../flow_runs/run_3.md)
...
Enter *Module IP Address* **192.168.1.34**
...
Press Enter - Ensure green check mark is displayed
![](../../images/run3_192_168_1_34_126_green.bmp)
